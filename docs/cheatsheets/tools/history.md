...
Quick reference for History, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `history`
- Configuration namespace: `tools/history/`
