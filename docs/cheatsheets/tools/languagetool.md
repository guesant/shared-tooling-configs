...
Quick reference for Languagetool, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `languagetool`
- Configuration namespace: `tools/languagetool/`
