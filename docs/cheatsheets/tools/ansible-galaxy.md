...
Quick reference for Ansible Galaxy, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ansible-galaxy`
- Configuration namespace: `tools/ansible-galaxy/`
