...
Quick reference for Sed, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `sed`
- Configuration namespace: `tools/sed/`
- Discovery source: `guesant/hl-infrastructure/docs/`
- Current phase: inventory and reference

## Extended reference

A more detailed reference already exists at [Sed](../shell/text-processing.md).
