...
Quick reference for Ansible Playbook, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ansible-playbook`
- Configuration namespace: `tools/ansible-playbook/`
