...
Quick reference for Ssh Keyscan, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ssh-keyscan`
- Configuration namespace: `tools/ssh-keyscan/`
