...
Quick reference for Yamllint, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `yamllint`
- Configuration namespace: `tools/yamllint/`
