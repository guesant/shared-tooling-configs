...
Quick reference for OSV-Scanner, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `osv-scanner`
- Configuration namespace: `tools/osv-scanner/`
