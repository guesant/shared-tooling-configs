...
Quick reference for Passage, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `passage`
- Configuration namespace: `tools/passage/`
