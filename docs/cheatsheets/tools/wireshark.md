...
Quick reference for Wireshark, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `wireshark`
- Configuration namespace: `tools/wireshark/`
