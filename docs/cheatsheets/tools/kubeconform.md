...
Quick reference for Kubeconform, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `kubeconform`
- Configuration namespace: `tools/kubeconform/`
