...
Quick reference for Rfkill, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `rfkill`
- Configuration namespace: `tools/rfkill/`
