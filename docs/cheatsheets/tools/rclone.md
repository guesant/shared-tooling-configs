...
Quick reference for Rclone, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `rclone`
- Configuration namespace: `tools/rclone/`
