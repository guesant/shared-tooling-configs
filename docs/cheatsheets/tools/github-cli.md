...
Quick reference for GitHub CLI, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `github-cli`
- Configuration namespace: `tools/github-cli/`
