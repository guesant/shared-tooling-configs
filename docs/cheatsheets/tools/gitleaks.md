...
Quick reference for Gitleaks, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `gitleaks`
- Configuration namespace: `tools/gitleaks/`
