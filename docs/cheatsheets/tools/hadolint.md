...
Quick reference for Hadolint, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `hadolint`
- Configuration namespace: `tools/hadolint/`
