...
Quick reference for Ebtables, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ebtables`
- Configuration namespace: `tools/ebtables/`
