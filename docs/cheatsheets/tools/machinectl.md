...
Quick reference for Machinectl, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `machinectl`
- Configuration namespace: `tools/machinectl/`
