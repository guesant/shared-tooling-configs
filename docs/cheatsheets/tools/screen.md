...
Quick reference for Screen, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `screen`
- Configuration namespace: `tools/screen/`
