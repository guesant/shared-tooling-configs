...
Quick reference for Kube Bench, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `kube-bench`
- Configuration namespace: `tools/kube-bench/`
