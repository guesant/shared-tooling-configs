...
Quick reference for Kubeadm, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `kubeadm`
- Configuration namespace: `tools/kubeadm/`
