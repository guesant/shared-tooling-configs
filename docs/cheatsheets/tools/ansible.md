...
Quick reference for Ansible, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ansible`
- Configuration namespace: `tools/ansible/`
