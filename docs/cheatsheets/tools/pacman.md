...
Quick reference for Pacman, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `pacman`
- Configuration namespace: `tools/pacman/`
