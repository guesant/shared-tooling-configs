...
Quick reference for OpenTofu, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `opentofu`
- Configuration namespace: `tools/opentofu/`
