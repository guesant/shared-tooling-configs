...
Quick reference for Ast Grep, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ast-grep`
- Configuration namespace: `tools/ast-grep/`
