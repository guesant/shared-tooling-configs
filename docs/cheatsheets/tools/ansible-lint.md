...
Quick reference for Ansible Lint, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `ansible-lint`
- Configuration namespace: `tools/ansible-lint/`
