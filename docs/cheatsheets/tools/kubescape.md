...
Quick reference for Kubescape, a tool or engineering platform mentioned in the `guesant/hl-infrastructure` documentation.

## Repository mapping

- Catalog id: `kubescape`
- Configuration namespace: `tools/kubescape/`
